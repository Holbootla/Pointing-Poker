...
function CustomCoverPopup(): JSX.Element {
  ...
  const customCoverPopupVisible = useAppSelector((state) => state.customCover.customCoverPopupVisible
  );
  ...
  return (
  <>
    <Modal show={customCoverPopupVisible} onHide={closeCustomCoverPopup}>
